...
struct WorkoutData {
    ...
    static let day2Categories: [ExerciseCategory] = [
        ...
        ExerciseCategory(name: "Спина", exercises: [
            Exercise(name: "Вертикальная тяга широким хватом", sets: 4, reps: 12, defaultWeight: 30),
            Exercise(name: "Горизонтальная тяга (блок к поясу)", sets: 4, reps: 12, defaultWeight: 30)
        ]),
        ExerciseCategory(name: "Бицепс", exercises: [
            Exercise(name: "Сгибания на бицепс", sets: 3, reps: 12, defaultWeight: 10),
            Exercise(name: "Сгибания «молот»", sets: 3, reps: 12, defaultWeight: 10)
        ]),
        ExerciseCategory(name: "Задняя дельта", exercises: [
            Exercise(name: "Разведения в тренажёре (обратная бабочка)", sets: 3, reps: 15, defaultWeight: 20)
        ]),
        ExerciseCategory(name: "Кардио", exercises: [
            Exercise(name: "Ходьба", sets: 1, reps: 20, defaultWeight: nil)
        ])
